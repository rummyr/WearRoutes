...
import uk.me.ponies.wearroutes.locationHandling.ILocationHandler;
 ...
 */
public class PollingLocationHandler implements LocationListener ,ILocationHandler {
    ...
    private  class SlowLocationPoller implements LocationListener{
        private final String WAKELOCK_NAME = "SlowLocationPollerWakelock";
        ...
        private void acquirePartialWakeLock() {
            if (lockStatic == null) {
                ...
                powerManager = (PowerManager) PollingLocationHandler.this.mContext.getSystemService(Context.POWER_SERVICE);
            ...
            if (lockStatic != null) { // redundant check, but what the hell!
                ...
                lockStatic.acquire(TimeUnit.SECONDS.toMillis(Options.SlowPollingKeepAwakeForAtMostSecs)); // after 2 intervals we kinda give up!
            }
        }
        ...
        public void scheduleNext() {
            ...
            //NOTE: still, adding a WakeLock anyway to try to help matters
