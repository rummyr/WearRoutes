...
public class MyGridViewPager extends GridViewPager {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        Log.d("MyGridViewPager","onTouch ambient is " + isAmbient + "event was:" + ev + "context is " + o);
        ...
        Log.d("MyGridViewPager", "onTouchEvent is returning " + rv);
        return rv;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.d("MyGridViewPager", "oninterceptTouchEvent is returning " + rv);
        return rv;
    }
